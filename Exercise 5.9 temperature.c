...
void Temperatures(double Fahrenheit)
{
	...
	printf("Temperature in Fahrenheit is %9.2lf.\n", Fahrenheit);
	printf("Temperature in Celsius is %9.2lf.\n", Celsius);
	printf("Temperature in Kelvin is %9.2lf.\n", Kelvin);
}



update: bug is found.
	in codeblock and mingw, scanf() use %lf to read a doulble number.
/*
